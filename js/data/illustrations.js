export const illustrations = [
    {
        ...
        colorCount: 11,
        description:
            "도시에서 살아가는 집비둘기를 부드러운 로즈토프와 모브 계열로 표현한 정적 일러스트입니다.",
        source: "직접 제작",
        previewType: "svg",
        previewPath:
